...
@main_bp.route("/LiveDetector")
def live_page():
    return render_template("home_page.html")

@main_bp.route("/ProjectDescription")
def projectDesc_page():
    return render_template("projectDesc.html")

@main_bp.route("/ModelArchitecture")
def modelArch_page():
    return render_template("modelArch.html")
